...
from ab12phylo_gui.gtk_proj import project_dataset
...
class ab12phylo_app_base(Gtk.Application):
    TEMPLATE = repo.BASE_DIR / 'ab12phylo_gui' / 'files' / 'gui.glade'
    ICON = repo.BASE_DIR / 'ab12phylo_gui' / 'files' / 'favi.ico'
    ...
    def do_startup(self):
        ...
        self.set_accels_for_action(detailed_action_name='app.help', accels=['<Control>F1', '<Control>h'])
    ...
    def help(self, *args):
        ...
        bar.set_revealed(not bar.get_revealed())
